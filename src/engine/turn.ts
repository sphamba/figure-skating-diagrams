...
import { FootData, FootKeyframe } from './keyframe.js'
import { getQuaternionFromAngleAxis } from './quaternion.js'
import { bladeLength, Sequence } from './sequence.js'
...
export abstract class FootTurn {
  ...
  constructor(
    ...
    this.pathLengthEntry =
      pathLengthEntry ?? (smoothEntry ? defaultPathLengthSmooth : defaultPathLengthLinear)
    this.pathLengthExit =
      pathLengthExit ?? (smoothExit ? defaultPathLengthSmooth : defaultPathLengthLinear)
    this.keyframes = []
  }
